      ...
      >
        ...
        >
          ...
          <div className="bg-white border-b border-gray-100 px-8 py-6 flex justify-between items-center flex-shrink-0">
            <h2 className="text-2xl font-black text-gray-900 tracking-tight">주문 상세 정보</h2>
            <button
              onClick={onClose}
          ...
          <div className="p-8 lg:p-10 space-y-8 overflow-y-auto max-h-[65vh] custom-scrollbar">
            ...
            <div className="flex items-center p-6 bg-blue-50 rounded-2xl border border-blue-100/50">
              <div className="flex items-center gap-5">
                ...
                <div>
                  <p className="text-blue-600 font-black uppercase text-sm tracking-widest">결제상태</p>
                  <p className="text-gray-500 font-medium">{order.createdAt} 결제 완료</p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-y-8 gap-x-12">
              <div className="md:col-span-2">
                <label className="text-[11px] font-black text-blue-500 uppercase tracking-widest">구매한 Solution</label>
                <p className="text-2xl font-bold text-gray-900 mt-2 leading-tight">{order.orderTitle}</p>
              </div>
  
              <div className="space-y-1">
                <label className="text-[11px] font-black text-gray-400 uppercase tracking-widest">주문번호</label>
                <p className="text-base font-bold text-gray-700">{order.merchantUid}</p>
              </div>
  
              <div className="space-y-1">
                <label className="text-[11px] font-black text-gray-400 uppercase tracking-widest">구매자명</label>
                <p className="text-base font-bold text-gray-700">{order.buyerName}</p>
              </div>
  
              {/* 상세 구매 리스트 */}
              <div className="md:col-span-2 space-y-3">
                <label className="text-[11px] font-black text-blue-500 uppercase tracking-widest">상세 구매 내역</label>
                    ...
                    >
                      <div className="flex flex-col">
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          <span className="text-[10px] bg-white border border-gray-200 text-gray-500 px-1.5 py-0.5 rounded font-bold">Project |  {item.projectname}</span>
                          <span className="text-[10px] text-gray-400 font-medium">{item.strategytitle}</span>
                        </div>
                      </div>
              ...
              {order.receiptUrl && (
               <div className="md:col-span-2 space-y-3">
                 <label className="text-[11px] font-black text-gray-400 uppercase tracking-widest">전자 영수증 미리보기</label>
              ...
              <div className="md:col-span-2 pt-8 border-t border-gray-100 mt-4">
                <div className="flex justify-between items-center">
                  <label className="text-[11px] font-black text-gray-400 uppercase tracking-widest">최종 결제 금액</label>
                  <p className="text-4xl font-black text-gray-900 tracking-tighter">
                    {order.totalPrice?.toLocaleString()}<span className="text-lg ml-1 font-bold">원</span>
                  </p>
                </div>
              </div>
            </div>
