    ...
    <div className="space-y-4">
      {serverData.dtoList.map((OrderHistoryDTO, idx) => (
        <div
          ...
          className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 flex items-center gap-6 hover:shadow-md transition cursor-pointer"
        >
          <div
            className={`w-24 h-24 rounded-2xl flex-shrink-0 relative overflow-hidden bg-gradient-to-br ${
          ...
          <div className="flex-grow space-y-1">
            <div className="flex items-center gap-2">
              <span className="text-[10px] bg-gray-900 text-white px-2 py-0.5 rounded-full uppercase">
          ...
          <div className="text-right space-y-2">
            <p className="text-lg font-black text-gray-900">
              결제금액 {OrderHistoryDTO.totalPrice?.toLocaleString()}원{" "}
            </p>
            <button
