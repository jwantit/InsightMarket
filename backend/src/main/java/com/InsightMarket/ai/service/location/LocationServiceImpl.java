...
import com.InsightMarket.ai.dto.locationchatbot.comparison.PlacesDTO;
...
public class LocationServiceImpl implements LocationService {
    ...
    public LocationLLmResponseDTO getConsulting(LocationRequestDTO locationRequestDTO) {
        ...
        LocationLLmResponseDTO locationLLmResponseDTO = pythonClient.generateLocationReport(bestStore,worstStore,traceId,locationRequestDTO.getRadius());
